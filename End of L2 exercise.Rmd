...
We don't need to keep all these columns, we are really only interested in: site_no, sample_dt, parm_cd and result_va.  Can you made a new df with just these variables?
...
data1 <- data1 %>% mutate(Site = recode(site_no, 
                         ...
                         '0134277114' = "Treated"))
colnames(data1)
data1 <- data1 %>% dplyr::select(Site, Date=sample_dt, Analyte, Result=result_va)
